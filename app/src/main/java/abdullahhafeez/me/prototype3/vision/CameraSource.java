...
public class CameraSource {
    ...
    private CameraSource.PreviewFrameInterface previewFrameInterface = null;
...
Log.e("range",  Integer.toString(selectedFpsRange[0]));
    ...
    private byte[] createPreviewBuffer(Size previewSize) {
        ...
        // Creating the byte array as opposed to using this way and wrapping it, .allocate(),
    ...
    private class CameraPreviewCallback implements Camera.PreviewCallback {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            if(previewFrameInterface != null){
                try {
                    previewFrameInterface.getPreviewFrame(data, camera);
    ...
    public interface PreviewFrameInterface {

        void getPreviewFrame(byte[] data, Camera camera) throws FileNotFoundException;
