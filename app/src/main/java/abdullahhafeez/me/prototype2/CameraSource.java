...
/**
 * Created by Abdullah on 7/5/2017.
 */
...
public class CameraSource {
    ...
    CameraSource(Context context, FaceDetector faceDetector){
        this.mContext = context;
        this.faceDetector = faceDetector;
        this.aDD =new Object();
    }
    public void setRequestedFps(float var1) {
        if(var1 <= 0.0F) {
    ...
    public void setRequestedPreviewSize(int var1, int var2) {
        int var3 = 1000000;
    ...
    public void setFacing(int var1) {
        if(var1 != 0 && var1 != 1) {
    ...
    public CameraSource build() {
        CameraSource var10000 = this;
        CameraSource var10003 = this;
        this.getClass();
        var10000.aDP = var10003.new zzb(faceDetector);
        return this;
    }
    ...
    private class zzb implements Runnable {
        ...
        @SuppressLint({"Assert"})
        void release() {
            assert CameraSource.this.aDO.getState() == State.TERMINATED;
        ...
        public void run() {
            while(true) {
                ...
                synchronized(this.zzail) {
                    ...
                    var1 = (new Frame.Builder()).setImageData(this.aDX, CameraSource.this.aDG.getWidth(), CameraSource.this.aDG.getHeight(), 17).setId(this.aDW).setTimestampMillis(this.aDV).setRotation(CameraSource.this.zzbrh).build();
                    var2 = this.aDX;
                    this.aDX = null;
                }
    ...
    private class zzc implements android.hardware.Camera.PictureCallback {
        private CameraSource.PictureCallback aDY;
    ...
    private class zzd implements android.hardware.Camera.ShutterCallback {
        private CameraSource.ShutterCallback aDZ;
